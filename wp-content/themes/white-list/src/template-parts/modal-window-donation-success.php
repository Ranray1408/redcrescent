<div class="donation-success-popup">
    <p class="donation-success-popup__title">Я сделал пожертвование</p>
    <p class="donation-success-popup__subtitle">Расскажите об этом друзьям</p>
    <div class="donation-success-popup__socials">
        ...
        <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode('Я сделал пожертвование'); ?>" target="_blank" class="donation-success-popup__social-link" rel="noopener">
        ...
        <a href="https://api.whatsapp.com/send?text=<?php echo urlencode('Я сделал пожертвование ' . get_permalink()); ?>" target="_blank" class="donation-success-popup__social-link" rel="noopener">
        ...
        <a href="https://t.me/share/url?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode('Я сделал пожертвование'); ?>" target="_blank" class="donation-success-popup__social-link" rel="noopener">
