...
?>
<section class="donat-section" id="donat-subscription">
	<div class="container">
		<div class="donat-block">
			...
			<div class="donat-block__right-wrapper">
				...
				<form class="donat-block__form js-donation-subscription-form" method="POST">
					<h3 class="donat-block__form-title"><?php echo $form_text['form_title']; ?></h3>

					<input type="hidden" name="pay-period" value="monthly">
									...
									if (!empty($team_members)) {
										foreach ($team_members as $member) {
											...
											if (!empty($member_name) && !empty($member_id)) {
												echo '<option value="' . esc_attr($member_id) . '">' . esc_html($member_name) . '</option>';
											}
										}
									}
									?>
